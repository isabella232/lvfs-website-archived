...
`plugin directory <https://github.com/fwupd/fwupd/tree/master/plugins>`_.
...
`Lenovo ME device <https://github.com/fwupd/fwupd/blob/master/plugins/uefi/uefi.quirk>`_
